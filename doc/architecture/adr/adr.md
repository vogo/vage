...
- Run-parameter authorization before the model sees tools is a single-slot ParamResolver (parameterization, not a new plane), with routing Caller assembly kept in `BuildCaller` / `ComposeCaller`. See [0002-run-param-resolver.md](0002-run-param-resolver.md).
